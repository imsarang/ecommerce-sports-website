...
const ReviewOne = ({people,mystyle1,rateCount,average,id,productName,recommend,handleStage}) => {
  
  const [showReview,setReviewModal] = useState(false)
  ...
  return (<>
    <div style={{padding:'2% 2% 0 5%',width:'60%'}}>
        ...
        {
          showReview?<ReviewForm id={id} setReviewModal = {setReviewModal} productName={productName} handleStage={handleStage}/>:<></>
        }
        </>
  )
}
