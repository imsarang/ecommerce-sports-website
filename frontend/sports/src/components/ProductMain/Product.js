...
import AddtoCart from '../Info/InfoModal'
...
const Product = () => {
  ...
  return (<>{
    ...
    <div className='idvl-product-page' style={{
      padding: '5% 0 0 0'
    }}>
      <section className='product-info-1' style={{
        ...
        <div className='product-content-1' style={{
            ...
            item.category2 != 'Accessories' ?
              <div className='pro-size' style={{
                ...
                <div style={{
                  ...
                  <div className='pro-size-drop' style={{
                    padding: '1%',
                    width: '100%',
                    fontFamily: 'Oswald',
                    fontSize: '20px'
          ...
          {
            showAdd?<InfoModal 
            text={'Product Added To Cart'}setShow={setAddToCart} seconds={seconds} setSeconds={setSeconds}/>:<></>
          }
      ...
      <section className='product-content-2'>
        <div className='adv-tech-rev' style={{
          ...
          <div className='product-c-2-head' style={{
            ...
            <div onClick={() => handleStage('advantage')} className={stage=='advantage'?'curInfo':'defInfo'} id='adv'>Advantages</div>
            <div onClick={() => handleStage('technical')} className={stage=='technical'?'curInfo':'defInfo'} id='tech' >Technical Information</div>
            <div onClick={() => handleStage('review')} className={stage=='review'?'curInfo':'defInfo'} id='rev'>Reviews</div>
          </div>
