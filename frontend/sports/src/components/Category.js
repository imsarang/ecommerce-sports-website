...
const Category = () => {
  ...
  const handleProductsFromDatabase = async () => {
    const result1 = await fetch(
      `/api/v2/category?category1=${category}&category2=Accessories`
    );
    const result2 = await fetch(
      `/api/v2/category?category1=${category}&category2=Men`
    );
    const result3 = await fetch(
      `/api/v2/category?category1=${category}&category2=Women`
    );
    const result4 = await fetch(
      `/api/v2/category?category1=${category}&category2=Kids`
    );
